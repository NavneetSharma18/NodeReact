...
const Cart = ({cartCheckdivclas},{cartCheckoutclas},{toggleVisibilityCart})=>{
  ...
  return (
           ...
           <div classNameName="register_div">
              ...
              <div className={cartCheckoutclas} id="checkout">
                ...
                <div className="flex items-end lg:flex-row flex-col justify-end" id="cart">
                   <div className="h-screen bg-gray-100 pt-5">
                    <div className="flex items-center text-gray-500 hover:text-gray-600 dark:text-white cursor-pointer" onClick={toggleVisibilityCart}>
